	...
	return (
		<main className='main'>
			...
			<p>
				...
				<a href='https://mon-congelateur.kevin-milet.fr'>
					https://mon-congelateur.kevin-milet.fr
				</a>{' '}
			...
			<p>
				<strong>Propriétaire</strong> : Kevin Milet – 48E avenue du général
				Faidherbe 80300 Albert
				<br />
				<strong>Responsable publication</strong> : Kevin Milet –
				contact@kevin-milet.fr
				<br />
				Le responsable publication est une personne physique ou une personne
				morale.
				<br />
				<strong>Webmaster</strong> : Kevin Milet – contact@kevin-milet.fr
				<br />
				<strong>Hébergeur</strong> : O2Switch – Chemin des Pardiaux 63000
				Clermont-Ferrand (+33) 0444446040
				<br />
				<strong>Délégué à la protection des données</strong> : Kevin Milet –
				contact@kevin-milet.fr
				<br />
			</p>
			...
			<p>
				...
				responsable du traitement des Données Personnelles est : Kevin Milet.{' '}
				<a href='https://mon-congelateur.kevin-milet.fr'>
					https://mon-congelateur.kevin-milet.fr
				</a>
				est représenté par N/A, son représentant légal
			</p>
			<p>
			...
			Kevin Milet – DPO, Kevin Milet <br />
			48E avenue du général Faidherbe 80300 Albert.
			<p>
			...
			<div ng-bind-html='rgpdHTML'>
				...
				<p>
					...
					période maximale de 9 mois après la fin de la relation contractuelle:
					<br />
					nom, prénom, email
				</p>
				<p>
				...
				<p>
					{' '}
					Ces &nbsp;données sont conservées pour une période maximale de 1 mois
